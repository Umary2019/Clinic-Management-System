...
const AuthShell = ({
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-4 py-8">
      ...
      >
        <section className="hidden flex-col justify-between bg-[linear-gradient(140deg,#0f766e,#0f766e_45%,#f59e0b)] p-10 text-white md:flex">
          <div>
            <p className="text-xs uppercase tracking-[0.25em] text-white/90">CareFlow CMS</p>
            <h1 className="mt-4 text-4xl leading-tight">Run your clinic with clinical precision and modern speed.</h1>
